export default function WaitPage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-16 text-center bg-white text-black">
      <h1 className="text-4xl font-bold mb-4">Página de Desenvolvedor de Sistemas</h1>
      
      <p className="text-lg max-w-xl mb-6">
        Esta seção está em construção no momento. Em breve, você poderá consultar aqui conteúdos exclusivos sobre minha trajetória como Desenvolvedor de Sistemas.
      </p>
